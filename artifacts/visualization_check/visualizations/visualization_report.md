# claimreview Visualization Report
...
**Trend seen:** All observed label values fell into `fake`.
...
**Trend seen:** `without context` dominates the context coverage mix at 100.0%, well above `with context` by 4.0.
...
**Trend seen:** All top-line metrics are strong; `accuracy` leads at 1.000 and the weakest metric is still 1.000.
