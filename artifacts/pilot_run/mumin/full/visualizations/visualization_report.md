...
**Trend seen:** `without context` dominates the context coverage mix at 100.0%, well above `with context` by 97.0.
...
**Trend seen:** All top-line metrics are strong; `precision` leads at 1.000 and the weakest metric is still 0.969.
